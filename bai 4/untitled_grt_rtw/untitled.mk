...
## Generated on : Thu Jun 18 16:14:17 2020
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\untitled_grt_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=untitled -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\untitled_grt_rtw\rtGetInf.c $(START_DIR)\untitled_grt_rtw\rtGetNaN.c $(START_DIR)\untitled_grt_rtw\rt_nonfinite.c $(START_DIR)\untitled_grt_rtw\untitled.c $(START_DIR)\untitled_grt_rtw\untitled_data.c
...
OBJS = rt_logging.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj untitled.obj untitled_data.obj
...
{$(START_DIR)\untitled_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\untitled_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
