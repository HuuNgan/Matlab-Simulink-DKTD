###########################################################################
## Makefile generated for Simulink model 'temp_response'. 
## 
## Makefile     : temp_response.mk
## Generated on : Thu Jun 18 13:42:09 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\temp_response.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:\MatLab\Simulink\CSDKTD~1\BAI4~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = temp_response_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = temp_response_ref.rsp
CMD_FILE                  = temp_response.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\temp_response.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\temp_response_grt_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=temp_response -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\temp_response_grt_rtw\rtGetInf.c $(START_DIR)\temp_response_grt_rtw\rtGetNaN.c $(START_DIR)\temp_response_grt_rtw\rt_nonfinite.c $(START_DIR)\temp_response_grt_rtw\temp_response.c $(START_DIR)\temp_response_grt_rtw\temp_response_data.c
...
OBJS = rt_logging.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj temp_response.obj temp_response_data.obj
...
{$(START_DIR)\temp_response_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\temp_response_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
