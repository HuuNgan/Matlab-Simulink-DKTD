###########################################################################
## Makefile generated for Simulink model 'temp_pid_ctrl'. 
## 
## Makefile     : temp_pid_ctrl.mk
## Generated on : Thu Jun 18 16:31:06 2020
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\temp_pid_ctrl.exe
...
MODELREF_LINK_RSPFILE_NAME = temp_pid_ctrl_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = temp_pid_ctrl_ref.rsp
CMD_FILE                  = temp_pid_ctrl.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\temp_pid_ctrl.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\temp_pid_ctrl_grt_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=temp_pid_ctrl -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\temp_pid_ctrl_grt_rtw\rtGetInf.c $(START_DIR)\temp_pid_ctrl_grt_rtw\rtGetNaN.c $(START_DIR)\temp_pid_ctrl_grt_rtw\rt_nonfinite.c $(START_DIR)\temp_pid_ctrl_grt_rtw\temp_pid_ctrl.c $(START_DIR)\temp_pid_ctrl_grt_rtw\temp_pid_ctrl_data.c
...
OBJS = rt_logging.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj temp_pid_ctrl.obj temp_pid_ctrl_data.obj
...
{$(START_DIR)\temp_pid_ctrl_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\temp_pid_ctrl_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
